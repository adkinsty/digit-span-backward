...
let expName = 'digit-span-backward';  // from the Builder filename that created this script
...
function experimentInit() {
  ...
  instructions = new visual.TextStim({
    win: psychoJS.window,
    name: 'instructions',
    text: 'In this task you will be required to memorise the number sequence presented. After viewing the number sequence you will recall the numbers in REVERSE ORDER. You will begin by trying to memorize lists of 3 numbers. If you are able to correctly recall two out of three lists you will proceed to longer list trials. Type out your answer in REVERSE ORDER when "Recall" screen appears using the numbers at the top of the keyboard. If you make a mistake you can use backspace to correct it. Press enter to confirm your answer. Feedback will be provided. Press space to start the experiment. ',
    font: 'Arial',
    units: undefined, 
